...
public class AsciiInterpreter implements Interpreter
{
    ...
    {
        try {
        	byte[] d = data.getBytes(ISOUtil.ENCODING);
            System.arraycopy(d, 0, b, offset, d.length);
//            System.out.println("haha:" + NumberUtils.toHex(b));
//            System.out.println("haha2:" + data + " " + NumberUtils.toHex(data.getBytes(ISOUtil.ENCODING)));
