...
import au.com.ds.ef.HandlerCollection.EventType;
...
import com.framework.runtime.application.process.AsyncQueueExecutor;
...
public class EasyFlow<C extends StatefulContext> {
    ...
    private void prepare() {
        if (executor == null) {
            executor = new AsyncQueueExecutor();
        }
    }
    ...
    public <C1 extends StatefulContext> EasyFlow<C1> whenEventFail(EventHandler<C1> onEvent) {
        handlers.setHandler(EventType.EVENT_FAIL, null, null, onEvent);
        return (EasyFlow<C1>) this;
    }
            ...
            execute(new Runnable() {
                ...
                public void run() {
                    try {
                        ...
                        boolean result = handlers.callOnEventTriggered(event, stateFrom, stateTo, context);
                        ...
                        if(result)
                        	...
                        	handlers.callOnEventFailed(event, stateFrom, stateTo, context);
                    } catch (Exception e) {
