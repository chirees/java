...
public class ExecutionException extends RemotingException {
    ...
    public ExecutionException(Object request, NetConnection channel, String message, Throwable cause){
        super(channel, message, cause);
        this.request = request;
    }

    public ExecutionException(Object request, NetConnection channel, String msg){
        super(channel, msg);
        this.request = request;
    }

    public ExecutionException(Object request, NetConnection channel, Throwable cause){
        super(channel, cause);
        this.request = request;
    }
