/**
* @Project: agent-web
* @Package com.freemypay.agent.web.controller
...
/**
* FileName: UnicodeInputStream.java
* @Description: TODO 【Please describe the class in a word】
* @author: Hubert 
* @version: v1.0
* @create at: 2016年5月10日 下午5:11:14
* @reviewer:
* @review at:
*
* Revision history:
