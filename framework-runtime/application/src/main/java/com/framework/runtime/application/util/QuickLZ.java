...
public final class QuickLZ
{
	...
	public static void main(String[] args) {
		...
		String data = "fdsa房价快速大家fks大房房房房房房间少打发大水反对撒反对撒范德萨发生的发生地放大沙发沙发上大";
		byte[] pdata = QuickLZ.compress(data.getBytes(), 3);
		byte[] ddata = QuickLZ.decompress(pdata);
		}
		System.out.println(System.currentTimeMillis() - time);
//		System.out.print(data.getBytes().length + " " + pdata.length + " " + new String(ddata));
	}
